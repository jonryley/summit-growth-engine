...
<img src="images/SummitGBLPF.png" 
     width="1200" 
...
```mermaid
flowchart LR
    A["Stage 0 Signal"] --> B["Stage 1 Qualify"] --> C["Stage 2 Shape"] --> D["Stage 3 Convert"] --> E["Stage 4 Deliver"] --> F["Stage 5 Amplify"]
```
...
<p align="center">
  <img src="images/SGBL.png" 
       alt="Summit Gated Business Lifecycle" 
       width="900"/>
</p>
